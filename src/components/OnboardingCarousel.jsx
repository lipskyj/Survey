...
export default function OnboardingCarousel({ onDismiss }) {
    ...
    <div className="bg-white border border-gray-100 rounded-3xl p-6 sm:p-8 shadow-sm relative overflow-hidden">
      ...
      <AnimatePresence mode="wait">
        ...
        >
          ...
          <h3 className="text-xl sm:text-2xl font-black text-[#6B2D4A] mb-3">
            {step.title}
          </h3>
          <p className="text-sm sm:text-base text-gray-600 font-medium mb-8 max-w-md mx-auto">
            {step.description}
          </p>
        </motion.div>
      </AnimatePresence>
      ...
      <div className="flex items-center justify-between gap-3">
        ...
        <Button
          onClick={nextStep}
          className="bg-[#E85A24] hover:bg-[#D14A1A] text-white rounded-full px-8 font-bold"
        >
