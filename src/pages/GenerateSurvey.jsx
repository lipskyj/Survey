...
‼️ קריטי: כל היגד חייב להיות משפט המתאר מצב/רגש/חוויה שניתן להסכים או לא להסכים איתו.
❌ לא: "מה למדת?", "איך השפיע?", "אם היית יכול לשנות?"
✅ כן: "למדתי דברים חדשים", "הפעילות הייתה רלוונטית עבורי", "המנחה היה ברור"

═══════════════════════════════════════
📤 פורמט התשובה:
═══════════════════════════════════════
החזר JSON עם מערך של 10 היגדים בדיוק (לא שאלות!).
כל היגד כולל:
- prompt: משפט חיובי המתאר מצב/רגש (לא שאלה!)
