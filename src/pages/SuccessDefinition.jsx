...
🔒 AUDIENCE LOCK - קהל היעד הוא ${hebrewAudience} בלבד.

❗ CRITICAL - התאם את שפת ההצלחה לקהל:
- אם קהל = תלמידים: הגדרות הצלחה מנקודת מבט של תלמידים (למשל: "התלמידים ירחיבו ידע", "התלמידים ירגישו שייכות")
- אם קהל = מורים: הגדרות הצלחה מנקודת מבט של השפעה על תלמידים (למשל: "המורים יישמו שיטות חדשות", "המורים יזהו שיפור בתלמידים")
- אם קהל = הורים: הגדרות הצלחה מנקודת מבט של תרומה לילדים (למשל: "ההורים יבינו את התהליך", "ההורים ירגישו שותפות")
- אם קהל = הנהלה: הגדרות הצלחה מנקודת מבט של החלטות והשפעה מערכתית
...
רקע לקהל זה: ${audienceContext[audienceText] || ''}

צור 5 הגדרות הצלחה בעברית שמתאימות בדיוק לקהל ${hebrewAudience}.
כל הגדרה תתחיל עם הגוף המתאים (התלמידים/המורים/ההורים/ההנהלה) ותהיה קצרה (עד 12 מילים).

❌ דוגמאות שגויות (אם קהל = תלמידים):
- "המורים יפגינו הבנה עמוקה" (זה מדבר על מורים, לא על תלמידים!)
- "ההנהלה תראה שיפור" (זה מדבר על הנהלה, לא על תלמידים!)

✅ דוגמאות נכונות (אם קהל = תלמידים):
- "התלמידים ירחיבו ידע על הנושא"
